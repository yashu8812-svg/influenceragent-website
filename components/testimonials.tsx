...
const testimonials = [
  ...
  },
  {
    ...
    company: "PaySmart",
    content:
      "We tried three other agencies before. InfluencerAgent was the first one that actually understood fintech audiences. The creators they recommended made complex UPI features feel relatable.",
  },
  {
    ...
    company: "BiteBox",
    content:
      "The viral food challenge they designed for us was absolute genius. 52 million views, 8,400 UGC pieces, and a 28% increase in footfall. Best marketing spend we have ever made.",
  },
  {
    ...
    company: "UrbanThread",
    content:
      "Their regional creator network is unmatched. We reached audiences in Tamil Nadu and West Bengal that we had never been able to access before. Sales in tier-2 cities jumped 180% during the festive campaign.",
  },
  {
    ...
    company: "LearnFirst",
    content:
      "As an edtech brand, finding creators who can explain complex concepts simply is tough. InfluencerAgent nailed it with 85K signups at just 42 rupees CPA. Their creator vetting process is seriously thorough.",
  },
  {
      ...
      <div className="border-t py-12 [border-image:linear-gradient(to_right,transparent,--theme(--color-slate-400/.25),transparent)1] md:py-20">
        ...
        <div className="mx-auto max-w-3xl pb-12 text-center">
          ...
          <p className="text-lg text-indigo-200/65">
            Hear from the marketing leaders who have seen real results with our influencer campaigns.
          </p>
        </div>
